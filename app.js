...
function cadastrarDespesa() {
   ...
   if(despesa.validarDados()) {
    ...
    document.getElementById('exampleModalLabel').className = 'text-sucess'
    ...
    document.getElementById('modal_conteudo').innerHTML = 'Nao foi possivel registrar o conteudo, Verifique se todas as opções foram preenchidas'
